...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.getStatusClasses = function (server) {
        return {
    ...
    AppComponent.prototype.onAddServer = function () {
        this.servers.push({
            instanceType: 'small',
            name: 'New Server',
            status: 'stable',
...
/* harmony import */ var _shorten_pipe__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./shorten.pipe */ "./src/app/shorten.pipe.ts");
/* harmony import */ var _filter_pipe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./filter.pipe */ "./src/app/filter.pipe.ts");
/* harmony import */ var _reverse_pipe__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./reverse.pipe */ "./src/app/reverse.pipe.ts");
/* harmony import */ var _sort_pipe__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./sort.pipe */ "./src/app/sort.pipe.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _shorten_pipe__WEBPACK_IMPORTED_MODULE_4__["ShortenPipe"],
                _filter_pipe__WEBPACK_IMPORTED_MODULE_5__["FilterPipe"],
                _reverse_pipe__WEBPACK_IMPORTED_MODULE_6__["ReversePipe"],
                _sort_pipe__WEBPACK_IMPORTED_MODULE_7__["SortPipe"]
            ],
            imports: [
...
var SortPipe = /** @class */ (function () {
    ...
    SortPipe.prototype.transform = function (value, propName) {
...
module.exports = __webpack_require__(/*! P:\kurs\Angular\pipes-assignment-start\src\main.ts */"./src/main.ts");
